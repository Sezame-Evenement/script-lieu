document.addEventListener("DOMContentLoaded", function () {
    ...
    function addTimeRange(hour, formattedSelectedDate, data, selectedDate, isPrevDay = false, isNextDay = false) {
    ...
    function removeTimeRange(hour, formattedSelectedDate, data, selectedDate, isPrevDay = false, isNextDay = false) {
